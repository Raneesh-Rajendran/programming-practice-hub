package main.java.data_structures.linkedlist.circular.two;
    ...
    public void deleteNode(Value nodeValue) {
        if (!isListExists())
            ...
            for (int idx = 0; idx < getSize(); idx++) {
                if (nodeValue.getInteger() != null && tempNode.getValue().getInteger() != null
                        && nodeValue.getInteger().equals(tempNode.getValue().getInteger())) {
                    location = idx;
                    break;
                }
                if (nodeValue.getString() != null && tempNode.getValue().getString() != null
